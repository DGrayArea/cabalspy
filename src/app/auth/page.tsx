        ...
        <Card id="login-section" className="glass border-white/10 rounded-4xl sm:rounded-4xl shadow-2xl overflow-hidden">
          ...
          <CardContent className="px-5 sm:px-8 pb-8 sm:pb-10 flex flex-col gap-3 sm:gap-4">
            ...
            <Button 
              ...
              variant="glass" 
              className="w-full py-5 sm:py-7 rounded-xl sm:rounded-2xl border-white/5 hover:border-indigo-400/40 hover:bg-indigo-400/5 group"
            >
              <div className="bg-[#5865F2] p-1 sm:p-1.5 rounded-lg mr-2 sm:mr-3 group-hover:scale-110 transition-transform">
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span className="font-bold text-sm sm:text-base">Continue with Discord</span>
            </Button>
