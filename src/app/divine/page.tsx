...
function HomeContent() {
  ...
  const {
    ...
    () => ({
      ...
      pagedFinal: finalStretch.slice(
        pageFinal * pageSize,
        (pageFinal + 1) * pageSize
      ),
      pagedMigrated: migrated.slice(
        pageMigrated * pageSize,
        (pageMigrated + 1) * pageSize
      ),
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">
                Real-time token tracking and trading
              </p>
              <Link
                href="/pulse"
            ...
            <div className="flex items-center gap-4">
              ...
              {tokensError && (
                <div className="text-red-400 text-sm">Error: {tokensError}</div>
              )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex gap-1">
                  ...
                  <button
                    onClick={() =>
                      setPageNew((p) => Math.min(totalNewPages - 1, p + 1))
                    }
          ...
          <div className="bg-panel rounded-lg p-4 sm:p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-muted">
                  Page {pageFinal + 1} / {totalFinalPages}
                </span>
                <div className="flex gap-1">
                  <button
                  ...
                  <button
                    onClick={() =>
                      setPageFinal((p) => Math.min(totalFinalPages - 1, p + 1))
                    }
                    className="px-2 py-1 bg-blue-600 text-xs rounded disabled:bg-gray-600"
          ...
          <div className="bg-panel rounded-lg p-4 sm:p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-muted">
                  Page {pageMigrated + 1} / {totalMigratedPages}
                </span>
                <div className="flex gap-1">
                  <button
                  ...
                  <button
                    onClick={() =>
                      setPageMigrated((p) =>
                        Math.min(totalMigratedPages - 1, p + 1)
                      )
                    }
                    className="px-2 py-1 bg-blue-600 text-xs rounded disabled:bg-gray-600"
